...
In `FinishInFlight` mode, the effective rate during the switch will be less than 10, until all calls have completed. Also there may be a spike when the new rate begins with 20. In `Transition` mode, the effective rate may be _higher_ than 20.
